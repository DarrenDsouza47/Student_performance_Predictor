...
class DataTransformation:
            ...
            def initiate_data_transformation(self,train_path,test_path):
                    try:
                        ...
                        logging.info("applying preprocessor on train and test df")

                        transformed_train_df=preprocessor_obj.fit_transform(input_train_df)
                        transformed_test_df=preprocessor_obj.transform(input_test_df)
